  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <router-link to="/agregar_productos" class="nav-link d-flex align-items-center">
        <i class="bi bi-cart-plus me-2"></i>
        Agregar un producto
      </router-link>
      </li>
      <li class="nav-item active">
            <router-link to="/administrar_productos" class="nav-link d-flex align-items-center">
              <i class="bi bi-gear me-2"></i>
              Administrar productos</router-link>
      </li>
      <li class="nav-item active">
            <router-link to="/cerrar_sesion_admin" class="nav-link d-flex align-items-center">
...
export default {
  ...
  async mounted() { 
    ...
    try {
      const response = await axios.get('http://localhost:5000/api/inicio_admin', { withCredentials: true });
